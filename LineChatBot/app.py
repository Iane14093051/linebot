...
machine = TocMachine(
    ...
    transitions=[
        ...
        {'trigger': 'advance', 'source': 'user', 'dest': 'location', 'conditions': 'is_going_to_location'},
        {'trigger': 'advance', 'source': 'user', 'dest': 'contact_information', 'conditions': 'is_going_to_contact_information'},
         {'trigger': 'advance', 'source': 'user', 'dest': 'employee', 'conditions': 'is_going_to_employee'},
        
        
        {'trigger': 'advance', 'source': 'user', 'dest': 'reserve_people', 'conditions': 'is_going_to_reserve_people'},
